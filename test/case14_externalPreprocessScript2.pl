...
# Usage:  case14a_externalPreprocessScript2.pl <infile> <outfile>
...
dif case14a.yml case14c.yml -externalPreprocessScript2 case14_externalPreprocessScript2.pl

To modify one file without doing the diff:
    case14_externalPreprocessScript2.pl file1 file1.modified
